...
class Field : public sf::Drawable {
 ...
 public:
	...
	~Field() {
		for (auto& e : entity_array) delete e;
	}

	virtual void draw(sf::RenderTarget& target, sf::RenderStates states) const {
		target.draw(grid, states);

		for (auto& e : entity_array) target.draw(*e, states);
	}
...
class Simulation {
 ...
 public:
	Simulation() : window(sf::VideoMode::getDesktopMode(), "SaturnSimulator") {
